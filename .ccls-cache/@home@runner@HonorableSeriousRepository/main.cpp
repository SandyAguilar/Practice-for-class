...
cout<<"Course code    Credit Hours    Course Cost";
  cout<<endl;
cout<<courseCode[0]<<  CreditHours[0]<<    courseCost[0];
cout<<courseCode[1]<<  CreditHours[1]<<    courseCost[1];
cout<<courseCode[2]<<  CreditHours[2]<<    courseCost[2];
cout<<courseCode[3]<<  CreditHours[3]<<    courseCost[3];
  cout<<endl;
